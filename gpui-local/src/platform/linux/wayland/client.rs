...
pub(crate) struct WaylandClientState {
    ...
    // WlOutput protocol objects for per-output fullscreen
    wl_output_objects: HashMap<ObjectId, wl_output::WlOutput>,
...
impl WaylandClient {
    pub(crate) fn new() -> Self {
        ...
        let mut initial_wl_outputs: HashMap<ObjectId, wl_output::WlOutput> = HashMap::default();
            ...
            for global in list {
                match &global.interface[..] {
                    ...
                    "wl_output" => {
                        ...
                        initial_wl_outputs.insert(output.id(), output.clone());
        ...
        let mut state = Rc::new(RefCell::new(WaylandClientState {
            ...
            wl_output_objects: initial_wl_outputs,
            in_progress_outputs,
...
impl LinuxClient for WaylandClient {
    ...
    fn open_window(
        ...
        // Look up WlOutput for the requested display_id
        let target_output = params.display_id.and_then(|display_id| {
            state.wl_output_objects.values().find(|output| {
                output.id().protocol_id() == u32::from(display_id)
            }).cloned()
        });
            ...
            wl_registry::Event::Global {
                ...
                "wl_output" => {
                    let output = registry.bind::<wl_output::WlOutput, _, _>(
                        ...
                        state.wl_output_objects.insert(output.id(), output.clone());
